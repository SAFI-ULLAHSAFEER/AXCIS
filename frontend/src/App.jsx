...
const SERVICES = [
  { id:'support',    icon:<NetworkIco/>,   color:'#10b981', title:'Global IT Support',           short:'Empowering global businesses with agile IT solutions, bridging geographical gaps seamlessly.',                                tagline:'Empowering global businesses with agile IT solutions, bridging geographical gaps seamlessly.',                                features:['Deskside support & network operations','Datacenter support & management','Multilingual helpdesk (L1–L3)','Proactive monitoring & incident response','Global fiber & edge networking solutions'], image:'https://images.unsplash.com/photo-1573164713714-d95e436ab8d6?w=800&q=80' },
  { id:'cloud',      icon:<CloudIco/>,     color:'#10b981', title:'Cybersecurity & Cloud',        short:'Zero-trust security and managed cloud operations.',                                                                          tagline:'Continuous, zero-trust cloud orchestration engineered for maximum reliability.',                                              features:['24/7/365 Security Operations Center (SOC)','Firewall & cloud security solutions','Advanced threat intelligence & zero-trust','GDPR, ISO 27001 compliance assurance','Multi-cloud architecture & migration'], image:'https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=800&q=80' },
  { id:'ai',         icon:<CpuIco/>,       color:'#10b981', title:'AI & Business Automation',     short:'Intelligent automation and AI solutions for enterprise.',                                                                    tagline:'Harness the power of AI to automate workflows and unlock business intelligence.',                                             features:['AI agent development & LLM integrations','Business process automation (RPA)','Machine learning models & predictive analytics','AI-powered chatbots & virtual assistants','Data pipelines & real-time intelligence dashboards'], image:'https://images.unsplash.com/photo-1677442136019-21780ecad995?w=800&q=80' },
        ...
        <main id="main-content">
          ...
          <section id="services" className="sec-pad sec-alt scroll-reveal" aria-labelledby="services-heading">
            <div className="container">
              ...
              {svc && (
                <div className="svc-detail" aria-live="polite" aria-label={`${svc.title} details`} style={{'--sc':svc.color, backgroundImage: `linear-gradient(rgba(0,0,0,0.85), rgba(0,0,0,0.95)), url(${svc.image})`, backgroundSize: 'cover', backgroundPosition: 'center'}}>
                  <div className="svc-detail__left">
                    <div className="svc-detail__icon" style={{fontSize: '3.5rem', marginBottom: '1.5rem', color: svc.color}} aria-hidden="true">{svc.icon}</div>
